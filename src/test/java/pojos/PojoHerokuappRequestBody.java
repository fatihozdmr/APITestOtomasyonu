...
public class PojoHerokuappRequestBody {
    ...
    public PojoHerokuappRequestBody(String firstname, String lasttname, int totalprice, boolean depositpaid, PojoHerokuappBookingdates bookingdates, String additionalneeds) {
        this.firstname = firstname;
